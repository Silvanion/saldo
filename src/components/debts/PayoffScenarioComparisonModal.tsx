  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Educational note */}
        <div className="text-xs text-text-muted flex items-start gap-2.5 bg-surface-2 p-3.5 rounded-xl border border-border">
        ...
        {decisionSummary && (
          <div className="p-4 rounded-xl bg-brand-subtle/30 border border-brand/20 space-y-2 text-xs">
            ...
            <ul className="space-y-1.5 pl-6 list-disc text-text-muted text-xs leading-relaxed">
                ...
                >
                  <div className="space-y-3.5">
                    ...
                    <div className="border-b border-border/60 pb-2.5">
                      ...
                      {sc.createdAt && (
                        <span className="text-xs text-text-faint block mt-0.5">
                    ...
                    <div className="space-y-1">
                      <span className="text-xs font-semibold text-text-faint block">
                        Strategia spłaty:
                      </span>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold px-1.5 py-0.5 rounded bg-surface border border-border text-text-muted">
                          {strategyInfo.badge}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      {(() => {
                        ...
                        return (
                          <div className="pt-1">
                            <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-brand-subtle text-brand text-xs font-bold border border-brand/20">
                          ...
                          {sc.customDebtOrder.map((debtId, idx) => {
                            ...
                            return (
                              <li key={debtId} className="flex items-center gap-2">
                                <span className="w-4 h-4 rounded-full bg-brand-subtle text-brand text-xs font-bold flex items-center justify-center shrink-0">
                                  {idx + 1}
                                </span>
                  ...
                  {onLoadScenario && (
                    <button
                      ...
                      className="w-full py-2 px-3 rounded-xl border border-border bg-surface hover:bg-brand hover:text-text-inverse hover:border-brand transition text-xs font-bold text-text-main flex items-center justify-center gap-1.5 cursor-pointer focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:outline-none active:scale-[0.98] mt-2"
                    >
        ...
        <div className="flex items-center justify-end pt-2 border-t border-border">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-xl text-xs font-bold bg-surface-2 text-text-main hover:bg-surface-hover transition cursor-pointer focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:outline-none active:scale-[0.98]"
          >
            Zamknij
          </button>
        </div>
