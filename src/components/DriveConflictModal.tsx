      ...
      >
        ...
        <div className="flex items-start justify-between shrink-0 p-6 pb-4 border-b border-border sticky top-0 z-20 bg-bg-base/95 backdrop-blur-2xl">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-10 h-10 rounded-xl bg-warning-subtle text-warning border border-warning/20 flex items-center justify-center shrink-0">
              <AlertTriangle className="w-5 h-5" />
            </div>
            <div className="min-w-0">
              <h3 id="drive-conflict-title" className="text-lg font-bold text-text-main truncate" title="Wykryto konflikt wersji (Dysk Google)">Wykryto konflikt wersji (Dysk Google)</h3>
          ...
          <button
            onClick={onClose}
            aria-label="Zamknij"
            className="p-1 rounded-xl text-text-muted hover:text-text-main hover:bg-surface-offset transition-all active:scale-[0.98] shrink-0 focus-visible:ring-2 focus-visible:ring-focus-ring cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto min-w-0 p-6 space-y-5 custom-scrollbar">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border border-border rounded-xl p-4 bg-surface flex flex-col gap-2 min-w-0">
              <div className="flex items-center justify-between border-b border-border pb-2 gap-2">
                ...
                <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-brand-subtle text-brand border border-brand/20 shrink-0">
                  To urządzenie
                </span>
              </div>
            ...
            <div className="border border-border rounded-xl p-4 bg-surface flex flex-col gap-2 min-w-0">
              <div className="flex items-center justify-between border-b border-border pb-2 gap-2">
                ...
                <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-surface-2 text-text-main border border-border shrink-0">
                  Dysk Google
                </span>
              </div>
              <div className="text-xs text-text-muted space-y-1 mt-1">
          ...
          <div className="bg-warning-subtle border border-warning/20 rounded-xl p-3 text-xs text-text-main flex items-start gap-2.5">
            <AlertTriangle className="w-4 h-4 text-warning shrink-0 mt-0.5" />
            <div className="min-w-0">
              <p className="font-bold text-warning truncate" title="Profil wspólny: ostatni zapis wygrywa">
        ...
        <div className="flex flex-col sm:flex-row gap-2 p-6 pt-4 border-t border-border justify-end shrink-0 bg-bg-base/95 rounded-b-2xl">
          <button
            ...
            className="w-full sm:w-auto px-4 py-2.5 rounded-xl border border-border text-text-main font-bold text-xs hover:bg-surface-2 active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 shrink-0 focus-visible:ring-2 focus-visible:ring-focus-ring"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-surface-2 border border-border text-text-main font-bold text-xs hover:bg-surface-offset active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 shadow-sm shrink-0 focus-visible:ring-2 focus-visible:ring-focus-ring"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-brand text-text-inverse font-medium text-xs hover:bg-brand-hover active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 shadow-sm shrink-0 focus-visible:ring-2 focus-visible:ring-focus-ring"
          >
