      ...
      >
        ...
        <div className="flex items-start justify-between shrink-0 p-6 pb-4 border-b border-border sticky top-0 z-20 bg-bg-base/95 backdrop-blur-2xl">
          ...
          <button
            onClick={onClose}
            aria-label="Zamknij"
            className="p-1 rounded-xl text-text-muted hover:text-text-main hover:bg-surface-offset transition-colors active:scale-95 shrink-0 focus-visible:ring-2 focus-visible:ring-focus-ring"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
