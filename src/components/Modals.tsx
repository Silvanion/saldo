      ...
      <motion.div
       ...
       ref={modalRef}>
        <div className="shrink-0 p-6 pb-4 border-b border-border flex items-start justify-between min-w-0">
          ...
          <button onClick={onClose} aria-label="Zamknij" className="text-2xl text-text-muted hover:text-text-main hover:bg-surface-offset w-8 h-8 flex items-center justify-center rounded-full transition-colors active:scale-95 ml-4 shrink-0 leading-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand" id="close-goal-modal">
            &times;
          </button>
        </div>
      ...
      <motion.div
       ...
       ref={modalRef}>
        <div className="shrink-0 p-6 pb-4 border-b border-border flex items-start justify-between min-w-0">
          ...
          <button onClick={onClose} aria-label="Zamknij" className="text-2xl text-text-muted hover:text-text-main hover:bg-surface-offset w-8 h-8 flex items-center justify-center rounded-full transition-colors active:scale-95 ml-4 shrink-0 leading-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand" id="close-goal-deposit-modal">
            &times;
          </button>
        </div>
      ...
      <motion.div
       ...
       ref={modalRef}>
        <div className="shrink-0 p-6 pb-4 border-b border-border flex items-start justify-between min-w-0">
          ...
          <button onClick={onClose} aria-label="Zamknij" className="text-2xl text-text-muted hover:text-text-main hover:bg-surface-offset w-8 h-8 flex items-center justify-center rounded-full transition-colors active:scale-95 ml-4 shrink-0 leading-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand" id="close-budget-modal">
            &times;
          </button>
        </div>
      ...
      <motion.div
       ...
       ref={modalRef}>
        <div className="shrink-0 p-6 pb-4 border-b border-border flex items-start justify-between min-w-0">
          ...
          <button onClick={onClose} aria-label="Zamknij" className="text-2xl text-text-muted hover:text-text-main hover:bg-surface-offset w-8 h-8 flex items-center justify-center rounded-full transition-colors active:scale-95 ml-4 shrink-0 leading-none cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand" id="close-pin-modal">
            &times;
          </button>
        </div>
            ...
            {onExportData && (
              <div className="pt-1">
                <button
                  ...
                  className="w-full bg-amber-100 hover:bg-amber-200 text-amber-900 font-bold py-2 px-3 rounded-lg text-xs active:scale-[0.98] transition-all flex items-center justify-center gap-2 border border-amber-300/60 shadow-2xs cursor-pointer min-w-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-600"
          ...
          <form id="pin-modal-form" onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-border p-3 text-center text-xl tracking-widest outline-none focus-visible:border-brand focus-visible:ring-1 focus-visible:ring-brand transition-colors"
                id="input-pin-code"
              />
            </div>
            ...
            <label className="flex items-start gap-2.5 p-2.5 rounded-lg border border-border bg-surface hover:bg-surface-offset transition-colors cursor-pointer text-xs text-text-main font-medium min-w-0">
              <input
                ...
                className="mt-0.5 w-4 h-4 rounded text-brand focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 shrink-0 outline-none"
          ...
          <form id="unlock-modal-form" onSubmit={handleSubmit} className="space-y-4 shrink-0">
            <div>
              <input
                ...
                value={pin}
                onChange={(e) => setPin(e.target.value)}
                className={`w-full rounded-xl border-2 p-4 text-center text-3xl tracking-[1em] outline-none transition-colors ${errorMsg ? 'border-red-300 focus-visible:border-red-500 focus-visible:ring-1 focus-visible:ring-red-500 text-red-600 bg-red-50' : 'border-border focus-visible:border-brand focus-visible:ring-1 focus-visible:ring-brand text-text-main'}`}
                id="input-unlock-pin"
              />
            </div>

            {errorMsg && (
              <p className="text-sm text-center text-rose-500 font-bold animate-fade-in" id="unlock-error-msg">
                {errorMsg}
              </p>
            )}
          </form>
        ...
        <div className="shrink-0 p-8 pt-4 border-t border-border bg-bg-base/95 rounded-b-3xl">
          <div className="space-y-3">
            <button
              ...
              className="w-full rounded-xl bg-brand py-4 text-sm font-bold text-white shadow-lg hover:bg-brand-hover active:scale-[0.98] transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2"
            ...
            <button
              ...
              className="w-full rounded-xl py-3 text-sm font-semibold text-text-faint hover:text-text-main hover:bg-surface-offset active:scale-[0.98] transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
              id="btn-unlock-other"
            >
