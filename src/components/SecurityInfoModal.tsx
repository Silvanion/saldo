      ...
      >
        <div className="shrink-0 p-6 md:p-8 pb-4 border-b border-border relative">
          <button
            ...
            aria-label="Zamknij"
            className="absolute top-5 right-5 text-2xl leading-none text-text-muted hover:text-text-main hover:bg-surface-offset w-8 h-8 flex items-center justify-center rounded-full transition-colors active:scale-95 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          ...
          <div className="flex items-center gap-3">
            <div className="p-3 bg-slate-100 text-text-muted rounded-xl shrink-0">
        ...
        <div className="shrink-0 p-6 md:p-8 pt-4 border-t border-border bg-bg-base/95 backdrop-blur-2xl rounded-b-3xl flex items-center justify-between gap-4">
          <span className="flex items-center gap-1.5 text-xs font-medium text-emerald-600 truncate" title="Ochrona aktywna">
            <CheckCircle2 className="w-4 h-4 shrink-0" />
            <span className="truncate">Ochrona aktywna</span>
          </span>
          <button
            onClick={() => toggleSecurityInfo(false)}
            className="px-5 py-2.5 rounded-xl bg-surface-offset hover:bg-border text-text-main font-bold text-xs active:scale-[0.98] transition-all shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          >
            Zamknij
          </button>
        </div>
